  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => getIt<CommentBloc>()
        ..add(FetchCommentsEvent(projectId: task!.projectId, taskId: task!.id)),
        ...
        builder: (context, state) {
          ...
          return Scaffold(
            ...
            body: BlocBuilder<CommentBloc, CommentState>(
              ...
              if (commentState is CreateCommentSuccess) {
                comments.add(commentState.comment);
              }

              return state is UpdateTaskLoadingState ||
                      commentState is CommentLoading
                            ...
                            Stack(
                              children: [
                                CustomMultiLineTextField(
                                    ...
                                    hintText: '${localization.postComment} ...',
                                    countLine: 5),
                                Positioned(
                                  right: 10,
                                  bottom: 10,
